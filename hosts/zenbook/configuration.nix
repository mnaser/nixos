...

{
  ...
  boot.initrd.luks.devices."luks-8f49233c-4e98-4711-a42a-70fd9a1c56fd".device =
    "/dev/disk/by-uuid/8f49233c-4e98-4711-a42a-70fd9a1c56fd";
  ...
  users.users.mnaser = {
    ...
    openssh.authorizedKeys.keys = [
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIFUZ4e9irE5jBQZKxpqnoeJns6pmSUNNW0xVTJWB31zF"
    ];
  };
